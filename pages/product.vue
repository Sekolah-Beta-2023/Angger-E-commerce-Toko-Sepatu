    ...
    <div class="container w-[90%] pt-[120px]">
      ...
      <div class="flex justify-between items-center w-full">
        <select
          ...
          class="dropdown-category p-3 border-2 border-btnColor rounded-md"
        >
        ...
        <div
          class="my-4 border-2 border-btnColor rounded-md w-[50%] flex justify-between items-center"
        >
          <input
            type="search"
          ...
          <div class="rounded-md p-5 w-[75%] bg-slate-50 flex-wrap">
            ...
            <div v-else>
              <div
                ...
                class="list-card flex justify-between items-center flex-wrap"
              >
                <div
                  v-for="(item, index) in combineFilterProducts"
                  :key="index"
                ...
                >
                  ...
                  <h3
                    class="border-t-2 font-semibold border-slate-200 pt-3 my-2"
                  >
                  ...
                  <p><DisplayRating :rating="Math.ceil(item.rating.rate)" /></p>
                  <div class="mb-2 flex justify-between items-center">
                    <span class="text-lg font-bold text-red-600">{{
                      hitungHargaAkhir(item.price)
                    }}</span>
                    <span class="line-through italic text-slate-600"
                      >$ {{ item.price }}</span
                    >
              ...
              <div
                v-else
                class="halaman-error flex justify-center flex-col items-center w-full h-80 bg-red-100 p-5"
              >
                <h2 class="text-red-600 text-4xl font-bold">Oooopss !</h2>
                <p class="text-xl italic text-red-600 mt-1">
                  Product Not Founds
                </p>
                <svg
                  id="currentIllo"
